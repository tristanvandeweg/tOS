...
void MCUFRIEND_kbv::LCD_WR_REG(uint8_t cmd)
{
    CS_ACTIVE;
	  CD_COMMAND;
    write8(cmd);
...
void MCUFRIEND_kbv::LCD_WR_DATA(uint8_t dat)
{
    CS_ACTIVE;
	  CD_DATA; 
	  write8(dat);
...
//			0xC0, 8, 0x0A, 0x4F, 0x00, 0x00, 0x02, 0x00, 0x01, 0x00,  //DM=1, BGR=1
    ...
    case 0x7783:
						...
						0x0001, 0x0100, // set SS and SM bit 0100
						...
						0x00FF, 0x0000,
						TFTLCD_DELAY,100,
						0x0003,0x0030, // set GRAM write direction and BGR=1.
						0x0007,0x0173,
	  ...
	  case 0x8230:
						//add for UC8230
						_lcd_capable = AUTO_READINC | REV_SCREEN  | INVERT_GS | INVERT_RGB;
